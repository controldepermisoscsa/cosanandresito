...
$stmt = $pdo->prepare("SELECT id_permiso, tipo_permiso, motivo, fecha_salida, hora_salida, fecha_regreso_aprox, hora_regreso_aprox FROM permisos WHERE id_usuario = ? AND tipo_pago = 'no_remunerado' AND estado = 'finalizado' AND genera_recuperacion = 1 ORDER BY fecha_salida DESC");
